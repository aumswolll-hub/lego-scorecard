...
/* 1) Make uploaded image smaller to avoid Vercel non-JSON HTML errors */
replaceFunction("fileToBase64", `function fileToBase64(file) {
  return new Promise((resolve, reject) => {
    ...
    reader.onload = () => {
      ...
      img.onload = () => {
        // ลดขนาดรูปให้เบาลงมากขึ้น กัน request ใหญ่เกินจน Vercel ส่ง HTML error กลับมา
        const MAX = 1100;
        ...
        // quality 0.72 = ยังอ่านตัวเลขได้ แต่ไฟล์เล็กกว่าเดิมมาก
...
/* 2) Replace handleAutofillFiles with safer JSON parsing + clearer error */
...
console.log("");
console.log("DONE: autofill JSON/readability fix patched successfully");
console.log("Backup:", backupPath);
console.log("");
console.log("Next:");
console.log("git add index.html patch-autofill-json-fix.js");
console.log('git commit -m "fix autofill non-json response handling"');
